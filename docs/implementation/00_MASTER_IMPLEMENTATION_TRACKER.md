...
| Phase 3 | **IN PROGRESS** — T01/T04/T05/T06/T10 landed 2026-08-04 |
...
| P3-T06 | Object storage abstraction | **DONE** | Local default; S3 optional |
| P3-T07 | Backup / restore runbook + drill | **NEXT** | |
| P3-T08 | Structured JSON logging | NOT STARTED | |
| P3-T09 | Metrics hooks | NOT STARTED | |
| P3-T10 | `REPORTS_ASYNC` default OFF | **DONE** | |
| P3-T11 | Acceptance tests | PARTIAL | Queue + async + storage tests |
