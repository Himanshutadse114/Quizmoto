...
@media(max-width:760px){.reader-shell{grid-template-rows:minmax(0,1fr) 122px}.reader-stage{padding:4px 6px 2px}.edge-arrow{display:none}.turn-hint{bottom:1px;font-size:8px}.control-row{padding:5px 5px 7px;align-items:stretch}.control-dock{width:100%;display:grid;grid-template-columns:minmax(82px,1fr) minmax(0,1.45fr) minmax(82px,1fr);grid-template-areas:"prev seek next" "zoom share full";gap:7px 6px;padding:8px;border-radius:14px;box-shadow:0 8px 24px rgba(23,49,58,.11)}#prevBtn{grid-area:prev}#nextBtn{grid-area:next}.seek-wrap{grid-area:seek;display:grid;grid-template-columns:auto 1fr;grid-template-areas:"label status" "slider slider";gap:3px 6px;min-width:0;align-items:center}.seek-label{grid-area:label;display:inline;font-size:10px;font-weight:750;color:var(--muted)}.page-slider{grid-area:slider;height:6px}.page-slider::-webkit-slider-thumb{width:18px;height:18px}.page-slider::-moz-range-thumb{width:16px;height:16px}.page-status{grid-area:status;justify-self:end;min-width:0;font-size:11px;font-weight:800}.page-jump{display:none}.nav-btn{min-width:0;width:100%;height:43px;padding:0 8px;font-size:11px;border-radius:10px}.nav-btn .word{display:inline}.tool-group{grid-area:zoom;display:grid;grid-template-columns:repeat(3,1fr);gap:4px;min-width:0}.tool-btn{height:43px;min-width:0;width:100%;padding:0 7px;font-size:11px;border-radius:10px}.tool-btn .label{display:inline}.zoom-value{display:inline-flex;min-width:0;font-size:10px}#shareBtn{grid-area:share}#fullBtn{grid-area:full}.reader-stage+.control-row{min-height:122px}}
</style>
</head>
<body>
<div class="reader-shell">
  ...
  <footer class="control-row">
    <div class="control-dock">
      ...
      <button class="tool-btn" id="fullBtn" title="Fullscreen" aria-label="Fullscreen"><span>⛶</span><span class="label">Full</span></button>
...
function pageDimensions(){
  ...
  const maxStageHeight=Math.max(320,window.innerHeight-(mobile?132:92));
  if(mobile){
