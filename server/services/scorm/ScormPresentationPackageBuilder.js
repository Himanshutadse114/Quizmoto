...
main{grid-area:stage;position:relative;min-width:0;min-height:0;overflow:hidden;padding:0;border:1px solid #bdd9d4;border-radius:20px;background:var(--surface);box-shadow:0 24px 60px rgba(11,81,71,.17)}
...
.presentation-page img{display:block;width:100%;height:100%;object-fit:cover;background:var(--surface)}
...
(function(){
  ...
  function updatePresentationButton(){var active=Boolean(fullscreenElement());byId('presentation-label').textContent=active?'Exit full screen':'Full screen';byId('presentation').setAttribute('aria-label',active?'Exit course fullscreen':'Enter course fullscreen');}
