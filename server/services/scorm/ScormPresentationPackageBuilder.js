...
<style>
${fontFaceCss}
:root{--background:${theme.background};--surface:${theme.surface};--primary:${theme.primary};--secondary:${theme.secondary};--text:${theme.text};--muted:${theme.muted};--primary-text:${theme.primaryText};--panel-width:clamp(240px,22vw,310px);--line:#d8e8e5;--stage:#062f2d;--stage-inner:#021918;--ok:#15803d;--ok-bg:#dcfce7;--bad:#b42318;--bad-bg:#fee4e2}
...
.rail-logo{display:block;width:auto;height:auto;max-width:100%;max-height:50px;margin:0 0 14px;object-fit:contain;object-position:left center}
...
main{grid-area:stage;position:relative;min-width:0;min-height:0;overflow:hidden;padding:clamp(8px,1.2vw,14px);border:1px solid #bdd9d4;border-radius:20px;background:var(--stage);box-shadow:0 24px 60px rgba(11,81,71,.17)}
.page{position:absolute;inset:0;display:none}
.page.active{display:flex}
.presentation-page{inset:clamp(8px,1.2vw,14px);align-items:center;justify-content:center;background:var(--stage-inner);border-radius:13px;overflow:hidden;padding:0}
.presentation-page img{display:block;width:100%;height:100%;object-fit:contain;background:var(--stage-inner)}
...
@media(max-height:520px) and (orientation:landscape){:root{--panel-width:210px}#app{padding:8px;gap:8px}.course-rail{padding:12px;gap:10px}.rail-logo{max-height:30px;margin-bottom:7px}.rail-kicker{margin-bottom:5px;font-size:.52rem}.title{font-size:1rem;-webkit-line-clamp:2}.rail-section{padding:8px}.rail-progress{gap:5px}.rail-controls{gap:6px}.btn{min-height:34px;padding:6px 7px;border-radius:8px;font-size:.66rem}.btn-presentation{gap:4px;font-size:.59rem}.btn-presentation svg{width:13px;height:13px}.shortcut{display:none}.quiz-page,.result-page{align-items:flex-start;padding:8px}.quiz-card,.result-card{padding:16px}.options{gap:7px}.option{min-height:42px;padding:9px 11px}.question{font-size:1.15rem;margin-bottom:12px}}
...
@media(max-width:820px){html,body{overflow:auto}#app,html:fullscreen #app,html:-webkit-full-screen #app{height:auto;min-height:100%;grid-template-columns:1fr;grid-template-areas:"stage" "controls";padding:10px;gap:10px}.course-rail{min-height:0;overflow:visible;padding:16px;border-radius:15px;gap:14px}.rail-heading{display:block}.rail-logo{max-height:38px;margin-bottom:9px}.title{font-size:1.2rem;-webkit-line-clamp:2}.rail-section{padding:10px}.rail-controls{margin-top:0}.shortcut{display:none}main{height:min(58vw,430px);min-height:220px;border-radius:15px;padding:6px}.presentation-page{inset:6px;border-radius:10px}.options{grid-template-columns:1fr;gap:8px}#app.is-assessment main{height:clamp(520px,78vh,720px)}.quiz-page,.result-page{padding:18px 14px;align-items:center}.quiz-card,.result-card{width:min(620px,100%);border-radius:16px;padding:18px}.eyebrow{margin-bottom:7px;font-size:.58rem;letter-spacing:.12em}.question{font-size:clamp(1rem,4.1vw,1.25rem);line-height:1.3;margin-bottom:13px}.option{min-height:44px;padding:10px 12px;border-width:1px;border-radius:11px;font-size:clamp(.76rem,3.15vw,.9rem);line-height:1.3}.feedback{margin-top:9px;padding:9px 10px;border-radius:10px;font-size:.76rem;line-height:1.35}.result-title{font-size:1.35rem}.score-ring{width:116px;height:116px;margin:16px auto}.score-ring::before{width:90px;height:90px}.score-value{font-size:1.6rem}.result-copy{font-size:.82rem}}
...
<div id="app" aria-busy="true">
  ...
  <aside class="course-rail" aria-label="Course controls">
    ...
    <div class="rail-section"><span>Now viewing</span><strong id="section-label">Presentation</strong></div>
