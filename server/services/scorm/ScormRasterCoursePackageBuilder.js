...
.qmx-learning-shell{display:grid;grid-template-columns:1fr;gap:30px;align-items:start}.qmx-learning-shell.has-image{grid-template-columns:minmax(0,1fr) minmax(420px,1fr);align-items:center;gap:52px}.qmx-learning-shell.has-image .qmx-copy{min-width:0}.qmx-native-media{margin:0;width:100%;aspect-ratio:16/9;border-radius:22px;overflow:hidden;border:1px solid var(--paper-3);background:var(--paper-2);box-shadow:0 18px 42px rgba(40,40,36,.11)}.qmx-native-media img{display:block;width:100%;height:100%;object-fit:cover}.qmx-cover-image{align-self:center}
