...
.qmx-stage{width:min(1240px,100%);margin:auto}.qmx-frame{display:grid;grid-template-columns:minmax(310px,.68fr) minmax(500px,1.32fr);gap:26px;align-items:stretch}.qmx-frame.qmx-wide{grid-template-columns:1fr}.qmx-copy{background:#fff;border:1px solid var(--line);border-radius:26px;padding:28px;box-shadow:0 18px 50px rgba(15,23,42,.07);display:flex;flex-direction:column;justify-content:center}.qmx-kicker{font-size:10px;font-weight:900;letter-spacing:.16em;text-transform:uppercase;color:var(--primary);margin-bottom:8px}.qmx-copy h2{font-size:clamp(26px,2.8vw,40px);line-height:1.06;letter-spacing:-.03em;margin:0 0 13px}.qmx-copy p{font-size:14px;line-height:1.6;color:#475569;margin:0}.qmx-visual{position:relative;background:linear-gradient(145deg,#fff,var(--soft));border:1px solid var(--line);border-radius:28px;min-height:430px;padding:8px;display:flex;align-items:center;justify-content:center;overflow:hidden;box-shadow:0 20px 56px rgba(15,23,42,.08)}.qmx-frame.qmx-wide .qmx-visual{min-height:455px}.qmx-visual img{display:block;width:auto;height:auto;max-width:96%;max-height:94%;object-fit:contain;margin:auto;transform:scale(1.035);transform-origin:center}.qmx-toolbar{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:16px}.qmx-points{display:flex;flex-wrap:wrap;gap:8px}.qmx-point{appearance:none;border:1px solid #e2e8f0;background:#fff;color:#475569;border-radius:999px;padding:8px 11px;font-size:11px;font-weight:800;cursor:pointer;transition:.18s}.qmx-point:hover,.qmx-point.active{border-color:var(--primary);background:var(--soft);color:var(--primary-dark);transform:translateY(-1px)}.qmx-count{font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.1em;color:#94a3b8;white-space:nowrap}.qmx-detail{margin-top:12px;padding:13px 15px;border-radius:16px;background:var(--soft);border-left:4px solid var(--primary);font-size:12px;line-height:1.5;font-weight:700;color:#334155;min-height:44px}.qmx-prompt{font-size:10px;color:#94a3b8;margin-top:9px;font-weight:700}.qmx-badge{position:absolute;right:14px;top:14px;background:rgba(255,255,255,.92);border:1px solid #e2e8f0;color:var(--primary);padding:7px 9px;border-radius:999px;font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:.09em;box-shadow:0 7px 20px rgba(15,23,42,.08)}.qmx-fallback{padding:30px;text-align:center;color:#64748b;font-size:13px}.qmx-enter{animation:qmxIn .5s ease both}@keyframes qmxIn{from{opacity:0;transform:translateY(14px)}to{opacity:1;transform:none}}@media(max-width:900px){.qmx-frame{grid-template-columns:1fr}.qmx-visual{min-height:320px;padding:8px}.qmx-visual img{max-width:95%;max-height:92%;transform:none}.qmx-copy{padding:20px}}@media(prefers-reduced-motion:reduce){.qmx-enter{animation:none}.qmx-point{transition:none}}
</style>`;
