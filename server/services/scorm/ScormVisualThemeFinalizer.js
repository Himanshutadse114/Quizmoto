...
.slide{background:transparent!important;padding:22px 28px!important;scrollbar-color:#334760 #08111C}
...
.qmx-copy{border-radius:24px!important;padding:30px!important}
.qmx-visual{
  background:radial-gradient(circle at 12% 10%,rgba(37,99,235,.06),transparent 20rem),linear-gradient(145deg,#FFFFFF 0%,var(--qmx-visual) 100%)!important;
  border:1px solid var(--qmx-visual-line)!important;border-radius:24px!important;
  box-shadow:0 20px 58px rgba(0,0,0,.30),inset 0 1px 0 rgba(255,255,255,.9)!important;
}
.qmx-visual img{filter:none!important}
.qmx-badge{background:rgba(7,12,20,.90)!important;color:#EAF2FF!important;border:1px solid #31445E!important;border-radius:999px!important;box-shadow:0 8px 22px rgba(0,0,0,.22)!important;backdrop-filter:blur(10px)}
.eyebrow,.qmx-kicker,.step-no,.hub-item b{color:var(--accent)!important;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace!important;font-size:11px!important;font-weight:700!important;letter-spacing:.09em!important}
.title,.qmx-copy h2,.final-card h1,.quiz-card h2{color:#F8FAFC!important;font-family:Inter,ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif!important;font-weight:750!important;letter-spacing:-.045em!important;line-height:1.02!important}
.lead,.qmx-copy p,.concept-card p,.step p,.milestone p,.compare-item,.hub-item{color:var(--qmx-body)!important;line-height:1.65!important}
.lead,.qmx-copy p{font-size:16px!important}
.qmx-detail{background:#101C2C!important;color:#D7E1EE!important;border:1px solid #243752!important;border-left:3px solid var(--primary)!important;box-shadow:none!important;font-size:14px!important;line-height:1.55!important}
.qmx-prompt,.qmx-count{color:var(--qmx-muted)!important}
.chip,.concept-number,.takeaway{background:#101C2C!important;color:#D9E8FF!important;border:1px solid #263A55!important;box-shadow:none!important}
.chip{font-size:12px!important;font-weight:650!important}.concept-card:before{background:linear-gradient(180deg,var(--primary),var(--accent))!important}
.hero{gap:30px!important;padding:34px!important}
.hero-art,.spot-visual{background:radial-gradient(circle at 28% 22%,color-mix(in srgb,var(--accent) 46%,transparent),transparent 34%),linear-gradient(145deg,var(--primary),var(--primary-dark))!important;color:#FFF!important;border:1px solid rgba(255,255,255,.10)!important;box-shadow:0 18px 50px rgba(0,0,0,.26)!important}
.hero-core svg{width:210px!important;height:210px!important}.spot-visual svg{width:210px!important;height:210px!important}.hero-art:before,.hero-art:after,.spot-visual:before{border-color:rgba(255,255,255,.16)!important}
...
.qmx-point{background:#0C1623!important;color:#AFC0D4!important;border:1px solid #263A54!important;border-radius:11px!important;padding:9px 12px!important;font-size:12px!important;font-weight:700!important;box-shadow:none!important}
.qmx-point:hover,.qmx-point:focus-visible,.qmx-point.active{background:#132541!important;color:#FFF!important;border-color:var(--primary)!important;transform:translateY(-1px)!important}.qmx-point.explored:not(.active){border-color:#31506F!important;color:#CFE0F2!important}
.quiz-wrap{max-width:920px!important}.quiz-card{padding:32px!important}.quiz-options{gap:12px!important}.quiz-option{background:#0A131F!important;color:#DCE6F2!important;border:1px solid #26374D!important;border-radius:15px!important;padding:16px!important;min-height:64px!important;font-size:14px!important;font-weight:650!important;box-shadow:none!important}
.quiz-option:hover:not(:disabled){background:#101E31!important;border-color:#47709C!important;transform:translateY(-1px)!important}.quiz-option.correct{background:#0A2B23!important;border:1px solid #238568!important;color:#B7F7DF!important}.quiz-option.incorrect{background:#32131D!important;border:1px solid #9F3550!important;color:#FFD1DB!important;text-decoration:none!important}
.feedback{border-radius:14px!important;background:#101D31!important;color:#DCE8F6!important;border:1px solid #2B4568!important;padding:14px 16px!important;text-align:left!important;font-size:13px!important;line-height:1.55!important;font-weight:650!important}
...
.nav-btn{min-height:42px!important;border-radius:12px!important;padding:10px 16px!important;font-weight:700!important;transition:transform .18s ease,border-color .18s ease,background .18s ease!important}
.nav-btn.primary{background:linear-gradient(135deg,var(--primary),var(--primary-dark))!important;color:#FFF!important;border:1px solid color-mix(in srgb,var(--primary) 72%,#FFF)!important;box-shadow:0 8px 22px color-mix(in srgb,var(--primary) 22%,transparent)!important}.nav-btn.primary:hover{transform:translateY(-1px)!important;filter:brightness(1.08)}
...
@media(max-width:900px){.slide{padding:18px!important}.hero{padding:24px!important}.qmx-copy{padding:22px!important}.lead,.qmx-copy p{font-size:15px!important}.qmx-visual{min-height:340px!important}.hero-core svg,.spot-visual svg{width:180px!important;height:180px!important}}
@media(max-width:680px){header{height:56px!important;padding:0 12px!important;gap:9px!important}footer{height:60px!important;padding:0 12px!important}.slide{padding:12px!important}.progress-shell{max-width:120px!important}.progress-text{display:none!important}.title{font-size:clamp(25px,8vw,34px)!important;line-height:1.02!important}.lead,.qmx-copy p{font-size:14px!important}.qmx-copy{padding:18px!important}.qmx-visual{min-height:270px!important;border-radius:18px!important}.quiz-card,.final-card{padding:22px!important}.quiz-options{grid-template-columns:1fr!important}.nav-btn{padding:9px 12px!important;font-size:12px!important}.part{font-size:9px!important}}
@media(max-height:720px) and (min-width:901px){.slide{padding-top:14px!important;padding-bottom:14px!important}.qmx-visual{min-height:350px!important}.qmx-copy{padding:22px!important}.lead,.qmx-copy p{font-size:14px!important;line-height:1.55!important}.hero-art,.spot-visual{min-height:285px!important;height:285px!important}}
...
function themeVariablesCss(theme = VISUAL_THEMES[1]) {
    const primary = safeColor(theme.primary, VISUAL_THEMES[1].primary);
    const primaryDark = safeColor(theme.primaryDark, VISUAL_THEMES[1].primaryDark);
    const accent = safeColor(theme.accent, VISUAL_THEMES[1].accent);
    const soft = safeColor(theme.soft, VISUAL_THEMES[1].soft);
    return `<style id="quizmoto-scorm-course-accent">:root{--primary:${primary}!important;--primary-dark:${primaryDark}!important;--accent:${accent}!important;--soft:${soft}!important}</style>`;
}

async function applyEditorialCourseTheme(buffer, theme = VISUAL_THEMES[1]) {
