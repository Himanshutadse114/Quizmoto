...
const PDF_COURSE_STYLE = `<style id="lmsgen-pdf-course-style">
  ...
  .publica-demo-shell{display:block!important;width:100%;max-width:none;margin:0!important;padding:0!important;border-radius:0!important;background:transparent!important;overflow:visible;box-sizing:border-box;transform:translateX(-2.5rem)}
