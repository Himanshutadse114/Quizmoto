    ...
    <div className="scorm-reports-page p-4 md:p-7 lg:p-9 max-w-7xl mx-auto relative z-10">
      ...
      <section className="reports-section rounded-2xl border overflow-hidden mb-6">
        <div className="reports-section-header p-4 md:p-5 border-b flex items-start gap-3">
          ...
          <div><div className="scorm-micro reports-accent text-[9px] uppercase">Consolidated evidence</div><h2 className="reports-section-title font-semibold mt-1">Platform reports</h2><p className="reports-muted text-[11px] mt-1">Export tenant-wide course, Publica and trackable-video evidence to PDF or Excel.</p></div>
        </div>
