    ...
    <div className="scorm-editorial scorm-theme-dark p-4 md:p-7 lg:p-9 max-w-7xl mx-auto pb-24">
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-5 mb-7 pb-7 border-b" style={{ borderColor: 'var(--scorm-line)' }}>
        <div className="max-w-3xl">
          ...
          <p className="text-sm mt-3 leading-relaxed" style={{ color: 'var(--scorm-muted)' }}>Keep the current slides for quiz-only changes, or upload a replacement PPTX/PDF. Rebuilding keeps the same course, invite link and tracking workspace.</p>
        </div>
