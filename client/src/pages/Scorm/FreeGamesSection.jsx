...
import { Gamepad2, LockKeyhole, Play, Shapes, Sparkles } from 'lucide-react';
    ...
    <section className="scorm-panel overflow-hidden mb-6">
      <div className="scorm-panel-header flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        <div>
          ...
          <p className="scorm-meta mt-1.5">Interactive learning games included inside LMSGEN. Start free and ask the Super Admin when your tenant needs the full curriculum.</p>
        </div>
      ...
      <div className="p-4 md:p-5">
        <a href="/games/geometry-quest/index.html" className="group block rounded-2xl border border-[var(--scorm-border,#D7E5E2)] bg-[var(--scorm-panel,#fff)] hover:border-[#4FC9BF] transition-colors overflow-hidden">
