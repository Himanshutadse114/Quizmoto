...
const PlayerRegister = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-quizmoto-darkPurple relative z-10 overflow-hidden font-sans">
            ...
            <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] bg-quizmoto-blue rounded-full blur-[120px] opacity-40 z-0"></div>
            <div className="absolute bottom-[-20%] left-[-10%] w-[50%] h-[50%] bg-quizmoto-red rounded-full blur-[120px] opacity-30 z-0"></div>
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-xs font-black uppercase tracking-[0.3em] text-white/60">Create Player Profile</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full p-4 bg-black/20 border-2 border-white/10 rounded-2xl text-center font-bold text-lg text-white focus:border-quizmoto-yellow focus:bg-black/40 outline-none transition-all placeholder:text-white/30"
                            value={username}
                    ...
                    <div>
                        <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-white/70 mb-3 ml-2">Email</label>
                        <input
                            type="email"
                    ...
                    <div>
                        ...
                        <input
                            type="password"
                            placeholder="••••••••"
                            className="w-full p-4 bg-black/20 border-2 border-white/10 rounded-2xl text-center font-bold text-lg text-white focus:border-quizmoto-yellow focus:bg-black/40 outline-none transition-all placeholder:text-white/30 tracking-[0.3em]"
                            value={password}
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-white/60 font-bold">
                        Already have a profile? <Link to="/player/login" className="text-quizmoto-yellow underline hover:text-white transition-colors ml-1">Login</Link>
                    </p>
                </div>
            </motion.div>
        </div>
