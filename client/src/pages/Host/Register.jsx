        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6 relative z-10">
            ...
            >
                <div className="text-center mb-6">
                    <h2 className="text-3xl font-black italic mb-1 text-white uppercase tracking-tight">Create Account</h2>
                    <p className="font-black opacity-40 uppercase tracking-[0.2em] text-[11px] text-white">Welcome to Quizmoto</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-quizmoto-yellow text-quizmoto-purple font-black py-4 rounded-xl text-lg shadow-[0_6px_0_0_#d18600] hover:shadow-none hover:translate-y-1 transition-all"
                    >
                        SIGN UP
                    </button>
                </form>
                ...
                <p className="mt-6 md:mt-8 text-center font-bold text-sm md:text-base text-white">
                    <span className="opacity-60">Already have an account?</span> <Link to="/login" className="text-white underline ml-1">Login here</Link>
                </p>
            </motion.div>
        </div>
    );
