            ...
            <header className="w-full max-w-7xl flex justify-between items-center mb-10 relative z-20">
                ...
                <div className="flex gap-4 flex-wrap justify-end items-center">
                    ...
                    <button
                        ...
                        className="px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border border-red-400/40 text-red-300 bg-red-500/10 hover:bg-red-500/20 transition-all"
                    >
                        Abort Session
                    </button>
                </div>
            ...
            <div className="w-full max-w-7xl flex flex-col gap-10 items-center justify-center mb-10 relative z-20">
                <div className="w-full flex flex-col md:flex-row gap-8 items-center justify-center">
                    <div className="flex flex-col gap-6 w-full max-w-md">
                        ...
                        >
                            ...
                            <h1 className="text-7xl font-black tracking-tighter mb-6 text-quizmoto-purple">
                                {pin}
                            </h1>
                    ...
                    <div className="flex flex-col items-center gap-6 w-full max-w-md">
                        <motion.button
                            ...
                            disabled={!canStart}
                            type="button"
                            className={`w-full py-8 rounded-[32px] font-black text-3xl shadow-xl flex items-center justify-center gap-4 transition-all ${
                                canStart
                        ...
                        <p className="font-black opacity-30 animate-pulse text-[10px] uppercase tracking-[0.3em]">
                            {canStart
                        ...
                        <button
                            type="button"
                            onClick={abortSession}
                            className="mt-2 px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest border border-red-400/40 text-red-300 bg-red-500/10 hover:bg-red-500/20 transition-all"
                        >
                            Abort Session
                        </button>
                    </div>
                ...
                >
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8 px-2">
                        <h3 className="font-black italic uppercase tracking-tight text-white/50 text-base">
                            Players
                        </h3>
                                    ...
                                    {Object.entries(groupedPlayers).map(([team, pList]) => {
                                        ...
                                        return (
                                            <motion.div
                                                layout
                                                key={team}
                                                className={`space-y-4 ${bgClass} p-8 rounded-[40px] border-2 ${borderClass}`}
                                            >
